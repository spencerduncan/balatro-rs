...
mod tests {
    ...
    fn test_default_priority_strategy() {
        ...
        assert_eq!(strategy.get_priority(JokerId::Joker), EffectPriority::Normal);
        assert_eq!(strategy.get_priority(JokerId::GreedyJoker), EffectPriority::Normal);
        assert_eq!(strategy.get_priority(JokerId::LustyJoker), EffectPriority::Normal);
    ...
    fn test_custom_priority_strategy() {
        ...
        assert_eq!(strategy.get_priority(JokerId::GreedyJoker), EffectPriority::Critical);
    ...
    fn test_custom_priority_strategy_with_default_fallback() {
        ...
        let strategy = CustomPriorityStrategy::with_fallback(
            mappings,
            Arc::new(DefaultPriorityStrategy),
        );
