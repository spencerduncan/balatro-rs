...
mod tests {
    ...
    fn test_extreme_values() {
        ...
        let extreme_joker = AllModifiersJoker::new(
            f64::MAX,
            f64::MIN_POSITIVE,
            i32::MAX,
            i32::MIN,
    ...
    fn test_clone_behavior() {
        ...
        assert_eq!(original.get_hand_size_modifier(), cloned.get_hand_size_modifier());
        assert_eq!(original.get_discard_modifier(), cloned.get_discard_modifier());
    }
