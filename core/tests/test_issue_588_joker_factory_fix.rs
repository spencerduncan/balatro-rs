use balatro_rs::{joker::{JokerId, JokerRarity}, joker_factory::JokerFactory};
use balatro_rs::action::Action;
use balatro_rs::game::Game;
use balatro_rs::stage::{Stage, Blind};
...
fn test_red_card_joker_correctly_created() {
    ...
    assert_ne!(joker.description(), "Red cards (Hearts and Diamonds) give +3 Mult when scored");
}
...
fn test_steel_joker_correctly_created() {
    ...
    assert_ne!(joker.description(), "This Joker gains X0.25 Mult for each Steel Card in your full deck");
}
