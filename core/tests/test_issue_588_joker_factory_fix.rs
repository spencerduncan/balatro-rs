...
fn test_jokers_in_rarity_lists() {
    ...
    // Fortune Teller is categorized as Common in the factory (despite joker impl saying Rare)
...
fn test_jokers_in_implemented_list() {
    ...
    assert!(implemented.contains(&JokerId::Reserved6)); // Red Card (pack skipping version)
